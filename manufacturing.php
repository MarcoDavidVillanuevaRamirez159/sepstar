...
<section class="manufacturing-hero d-flex align-items-center">    <div class="hero-video-wrapper">
        <video class="hero-video" autoplay muted loop playsinline poster="<?php echo BASE_URL; ?>img/fotos%20de%20fabrica%20y%20opengraph/fabrica%201.jpg">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade-right" data-aos-delay="100">
                ...
                <div class="d-flex align-items-center">
                    <a href="<?php echo BASE_URL; ?>contact.php" class="btn btn-outline-primary me-3">
            ...
            <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">                <div class="position-relative factory-video-container rounded-3 overflow-hidden shadow-lg">
                    <img src="<?php echo BASE_URL; ?>img/fotos%20de%20fabrica%20y%20opengraph/fabrica%202.jpg" alt="Factory Tour" class="img-fluid">
                ...
                <div class="tech-showcase p-5 bg-white rounded-3 shadow-lg" data-aos="fade-up">
                    <div class="row align-items-center">
                        <div class="col-lg-5 mb-4 mb-lg-0">
                            ...
                            <a href="<?php echo BASE_URL; ?>contact.php" class="btn btn-primary mt-3">Solicitar información</a>
                        </div>
                        <div class="col-lg-7">
                            <div class="tech-showcase-slider">
                                <div class="tech-image-container rounded-3 overflow-hidden">
                                    <img src="<?php echo BASE_URL; ?>img/equipo%20de%20trabajo%20o%20manufactura/fabricacion.jpg" alt="Tecnología de fabricación" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <div class="interactive-process position-relative">
                                <img src="<?php echo BASE_URL; ?>img/equipo%20de%20trabajo%20o%20manufactura/equipo%20de%20trabajo%202.jpg" alt="Proceso de fabricación" class="img-fluid rounded-3">
            ...
            <div class="col-12 mb-5 text-center">
              ...
              <div class="col-md-6 col-lg-4 mb-4">
                <div class="facility-gallery-item">
                    <img src="<?php echo BASE_URL; ?>img/fotos%20de%20fabrica%20y%20opengraph/fabrica%201.jpg" alt="Instalaciones Sepstar" class="img-fluid rounded-3 shadow">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="facility-gallery-item">
                    <img src="<?php echo BASE_URL; ?>img/fotos%20de%20fabrica%20y%20opengraph/fabrica%202.jpg" alt="Instalaciones Sepstar" class="img-fluid rounded-3 shadow">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="facility-gallery-item">
                    <img src="<?php echo BASE_URL; ?>img/fotos%20de%20fabrica%20y%20opengraph/fabrica%203.jpg" alt="Instalaciones Sepstar" class="img-fluid rounded-3 shadow">
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">                <div class="certification-item text-center h-100 p-4 bg-white rounded-3 shadow">
                    <div class="cert-icon-wrap mb-4 mx-auto d-flex align-items-center justify-content-center">
                        <img src="<?php echo BASE_URL; ?>img/certificados/certificado%20de%20wuhu%20sepstar%20iatf16949.jpg" alt="Certificado IATF 16949 - Wuhu Sepstar" class="certification-logo">
            ...
            <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="200">                <div class="certification-item text-center h-100 p-4 bg-white rounded-3 shadow">
                    <div class="cert-icon-wrap mb-4 mx-auto d-flex align-items-center justify-content-center">
                        <img src="<?php echo BASE_URL; ?>img/certificados/certificado%20nacional%20de%20la%20empreasa%20cientifica.png" alt="Certificado Nacional de Empresa Científica" class="certification-logo">
            ...
            <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">                <div class="certification-item text-center h-100 p-4 bg-white rounded-3 shadow">
                    <div class="cert-icon-wrap mb-4 mx-auto d-flex align-items-center justify-content-center">
                        <img src="<?php echo BASE_URL; ?>img/certificados/certificado%20zhuhai%20iatf16949.jpg" alt="Certificado IATF 16949 - Zhuhai Sepstar" class="certification-logo">
            ...
            <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="400">                <div class="certification-item text-center h-100 p-4 bg-white rounded-3 shadow">
                    <div class="cert-icon-wrap mb-4 mx-auto d-flex align-items-center justify-content-center">
                        <img src="<?php echo BASE_URL; ?>img/certificados/medium%20enterprises%20certificate.jpg" alt="Certificado de Empresa de Mediana Escala" class="certification-logo">
                ...
                <div class="certification-banner p-5 bg-white rounded-3 shadow position-relative overflow-hidden" data-aos="fade-up">
                    <div class="row align-items-center">
                        <div class="col-lg-7 position-relative z-index-1">
                            ...
                            <p class="lead mb-4">Nuestras certificaciones respaldan nuestro compromiso con los más altos estándares en procesos de fabricación.</p>                            <div class="d-flex flex-wrap cert-banner-logos">                                <img src="<?php echo BASE_URL; ?>img/certificados/certificado%20de%20empresa%20de%20alta%20tecnologia.jpg" alt="Certificado de Empresa de Alta Tecnología" class="me-4 mb-3 cert-banner-logo">
                                <img src="<?php echo BASE_URL; ?>img/certificados/certificado%20de%20empresa%20de%20alta%20tecnologia2.jpg" alt="Certificado de Empresa de Alta Tecnología 2" class="me-4 mb-3 cert-banner-logo">
                                <img src="<?php echo BASE_URL; ?>img/certificados/certificado%20nacional%20de%20la%20empreasa%20cientifica.png" alt="Certificado Nacional de Empresa Científica" class="me-4 mb-3 cert-banner-logo">
                            </div>
                        </div>
                        <div class="col-lg-5 d-none d-lg-block">
                            <div class="cert-banner-image">
                                <img src="<?php echo BASE_URL; ?>img/equipo%20de%20trabajo%20o%20manufactura/equipo%20de%20trabajo%201.jpg" alt="Equipo de trabajo" class="img-fluid rounded-3">
                            </div>
                        </div>
                    </div>
                    <!-- Background element -->
                ...
                <div class="cta-content p-5 rounded-3 position-relative overflow-hidden">
                    <div class="row align-items-center position-relative z-index-1">
                        ...
                        <div class="col-lg-4 text-center text-lg-end" data-aos="fade-left">
                            <a href="<?php echo BASE_URL; ?>contact.php" class="cta-btn btn btn-light btn-lg px-5 py-3">
