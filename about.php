...
<?php
// Incluir funciones y config antes de cualquier uso
require_once __DIR__ . '/includes/config.php';
require_once __DIR__ . '/includes/functions.php';

// Ahora sí cargar textos y variables
$about_texts = load_language_file('about');
$page_title = $about_texts['page_title'];
...
// Eliminar el sufijo .php si aparece en el breadcrumb
foreach ($breadcrumbs as $link => &$title) {
    if (strtolower($title) === 'about.php') {
        $title = $about_texts['page_title'];
    }
}
unset($title);

// Incluir header.php después de definir las variables
require_once __DIR__ . '/includes/header.php';
?>
}
<!-- Page Banner -->
<section class="page-banner" style="background-image: url('<?php echo BASE_URL; ?>img/fotos%20de%20fabrica%20y%20opengraph/fabrica%201.jpg');">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0" data-aos="fade-right">
                <div class="about-image position-relative">
                    <img src="<?php echo BASE_URL; ?>img/fotos%20de%20fabrica%20y%20opengraph/fabrica%201.jpg" alt="Fábrica Sepstar" class="img-fluid rounded shadow">
            ...
            <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
                <div class="certification-item text-center h-100 p-4 bg-white rounded-3 shadow">
                    <div class="cert-icon-wrap mb-4 mx-auto d-flex align-items-center justify-content-center">
                        <img src="<?php echo BASE_URL; ?>img/certificados/certificado%20de%20wuhu%20sepstar%20iatf16949.jpg" alt="<?php echo $about_texts['cert_1_title']; ?>" class="certification-logo">
                    </div>
                    <h5 class="mb-3"><?php echo $about_texts['cert_1_title']; ?></h5>
                    <p class="cert-desc mb-0 text-muted small"><?php echo $about_texts['cert_1_desc']; ?></p>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="200">
                <div class="certification-item text-center h-100 p-4 bg-white rounded-3 shadow">
                    <div class="cert-icon-wrap mb-4 mx-auto d-flex align-items-center justify-content-center">
                        <img src="<?php echo BASE_URL; ?>img/certificados/certificado%20nacional%20de%20la%20empreasa%20cientifica.png" alt="<?php echo $about_texts['cert_2_title']; ?>" class="certification-logo">
                    </div>
                    <h5 class="mb-3"><?php echo $about_texts['cert_2_title']; ?></h5>
                    <p class="cert-desc mb-0 text-muted small"><?php echo $about_texts['cert_2_desc']; ?></p>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">
                <div class="certification-item text-center h-100 p-4 bg-white rounded-3 shadow">
                    <div class="cert-icon-wrap mb-4 mx-auto d-flex align-items-center justify-content-center">
                        <img src="<?php echo BASE_URL; ?>img/certificados/certificado%20zhuhai%20iatf16949.jpg" alt="<?php echo $about_texts['cert_3_title']; ?>" class="certification-logo">
                    </div>
                    <h5 class="mb-3"><?php echo $about_texts['cert_3_title']; ?></h5>
                    <p class="cert-desc mb-0 text-muted small"><?php echo $about_texts['cert_3_desc']; ?></p>
                </div>
            </div>
            <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="400">
                <div class="certification-item text-center h-100 p-4 bg-white rounded-3 shadow">
                    <div class="cert-icon-wrap mb-4 mx-auto d-flex align-items-center justify-content-center">
                        <img src="<?php echo BASE_URL; ?>img/certificados/medium%20enterprises%20certificate.jpg" alt="<?php echo $about_texts['cert_4_title']; ?>" class="certification-logo">
                    </div>
                    <h5 class="mb-3"><?php echo $about_texts['cert_4_title']; ?></h5>
                    <p class="cert-desc mb-0 text-muted small"><?php echo $about_texts['cert_4_desc']; ?></p>
                </div>
            </div>
        </div>
        <div class="row mt-5">
                ...
                <div class="certification-banner p-5 bg-white rounded-3 shadow position-relative overflow-hidden" data-aos="fade-up">
                    <div class="row align-items-center">
                        <div class="col-lg-7 position-relative z-index-1">
                            <h3 class="display-6 mb-4"><?php echo $about_texts['cert_section_title']; ?></h3>
                            <p class="lead mb-4"><?php echo $about_texts['cert_section_desc']; ?></p>
                            <div class="d-flex flex-wrap cert-banner-logos">
                                <img src="<?php echo BASE_URL; ?>img/certificados/certificado%20de%20empresa%20de%20alta%20tecnologia.jpg" alt="Certificado de Empresa de Alta Tecnología" class="me-4 mb-3 cert-banner-logo">
