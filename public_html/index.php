...
<section class="hero-slider">
    <div class="owl-carousel hero-carousel">
        <div class="hero-slide" style="background-image: url('<?php echo BASE_URL; ?>/img/fotos de fabrica y opengraph/fabrica 1.jpg');">
        ...
        <div class="hero-slide" style="background-image: url('<?php echo BASE_URL; ?>/img/fotos de fabrica y opengraph/fabrica 2.jpg');">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-8 hero-content">
        ...
        <div class="hero-slide" style="background-image: url('<?php echo BASE_URL; ?>/img/fotos de fabrica y opengraph/fabrica 3.jpg');">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-8 hero-content">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade-right">
                <div class="about-image position-relative">
                    <img src="<?php echo BASE_URL; ?>/img/equipo de trabajo o manufactura/equipo de trabajo 1.jpg" alt="<?php echo SITE_NAME; ?>" class="img-fluid rounded shadow">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="service-card">
                    <div class="service-image">
                        <img src="<?php echo BASE_URL; ?>/img/productos/bomba peristaltica.jpg" alt="<?php echo $home_texts['service_1_title']; ?>">
                    </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="service-card">
                    <div class="service-image">
                        <img src="<?php echo BASE_URL; ?>/img/productos/panel de control lavavajillas.jpg" alt="<?php echo $home_texts['service_2_title']; ?>">
                    </div>
                    <div class="service-content">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                <div class="service-card">
                    <div class="service-image">
                        <img src="<?php echo BASE_URL; ?>/img/productos/luces traseras.jpg" alt="<?php echo $home_texts['service_3_title']; ?>">
                    </div>
                    <div class="service-content">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 product-item" data-category="automotive" data-aos="fade-up" data-aos-delay="100">
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?php echo BASE_URL; ?>/img/productos/luces traseras.jpg" alt="<?php echo $home_texts['product_1_title']; ?>">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 product-item" data-category="home-appliance" data-aos="fade-up" data-aos-delay="200">
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?php echo BASE_URL; ?>/img/productos/panel de control lavadora.jpg" alt="<?php echo $home_texts['product_2_title']; ?>">
                    </div>
                    <div class="product-content">
            ...
            <div class="col-lg-4 col-md-6 product-item" data-category="industrial" data-aos="fade-up" data-aos-delay="300">
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?php echo BASE_URL; ?>/img/productos/bomba peristaltica.jpg" alt="<?php echo $home_texts['product_3_title']; ?>">
                    </div>
                    <div class="product-content">
            ...
            <div class="col-lg-4 col-md-6 product-item" data-category="automotive" data-aos="fade-up" data-aos-delay="400">
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?php echo BASE_URL; ?>/img/productos/panel de control lavavajillas.jpg" alt="<?php echo $home_texts['product_4_title']; ?>">
                    </div>
                    <div class="product-content">
                        <div class="product-category"><?php echo $home_texts['automotive']; ?></div>
            ...
            <div class="col-lg-4 col-md-6 product-item" data-category="home-appliance" data-aos="fade-up" data-aos-delay="500">
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?php echo BASE_URL; ?>/img/productos/manija del refrigerador.jpg" alt="<?php echo $home_texts['product_5_title']; ?>">
                    </div>
                    <div class="product-content">
                        <div class="product-category"><?php echo $home_texts['home_appliance']; ?></div>
            ...
            <div class="col-lg-4 col-md-6 product-item" data-category="industrial" data-aos="fade-up" data-aos-delay="600">
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?php echo BASE_URL; ?>/img/productos/panel de control lavadora.jpg" alt="<?php echo $home_texts['product_6_title']; ?>">
                    </div>
                    <div class="product-content">
                        <div class="product-category"><?php echo $home_texts['industrial']; ?></div>
...
<section class="news-section">
    <div class="container">
        ...
        <p class="section-subtitle" data-aos="fade-up" data-aos-delay="100">
            Novedades y eventos recientes de Sepstar
        </p>
        <div class="row">
            <!-- Noticia 1 -->
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <div class="news-card">
                    <div class="news-image">
                        <img src="<?php echo BASE_URL; ?>/img/NOTICIAS/noticia reunion 2024/REUNIONANUAL2024.jpg" alt="Reunión Anual 2024">
                        <div class="news-date">17 Abr 2024</div>
                    </div>
                    <div class="news-content">
                        <h3><a href="#">Reunión Anual de la Empresa 2024</a></h3>
                        <p>La reunión anual de Sepstar se celebró con éxito, reuniendo a empleados y socios para compartir logros y planear el futuro.</p>
                        <div class="news-meta">
                            <span><i class="far fa-user"></i> Admin</span>
                            <span><i class="far fa-comments"></i> 3 comentarios</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="news-card">
                    <div class="news-image">
                        <img src="<?php echo BASE_URL; ?>/img/NOTICIAS/noticias aniversario wuhu/aniversario wuhu 1.png" alt="Aniversario Wuhu">
                        <div class="news-date">15 Mar 2024</div>
                    </div>
                    <div class="news-content">
                        <h3><a href="#">Celebración del Aniversario de Wuhu</a></h3>
                        <p>Sepstar celebró el aniversario de su planta en Wuhu, destacando el crecimiento y la innovación en la producción.</p>
                        <div class="news-meta">
                            <span><i class="far fa-user"></i> Admin</span>
                            <span><i class="far fa-comments"></i> 5 comentarios</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="news-card">
                    <div class="news-image">
                        <img src="<?php echo BASE_URL; ?>/img/NOTICIAS/noticias festival otono/noticias festival otono.jpg" alt="Festival de Otoño">
                        <div class="news-date">10 Feb 2024</div>
                    </div>
                    <div class="news-content">
                        <h3><a href="#">Festival de Otoño 2024</a></h3>
                        <p>El Festival de Otoño reunió a todo el equipo de Sepstar en una jornada de integración, cultura y celebración.</p>
                        <div class="news-meta">
                            <span><i class="far fa-user"></i> Admin</span>
                            <span><i class="far fa-comments"></i> 2 comentarios</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center mt-4" data-aos="fade-up">
            <a href="<?php echo BASE_URL; ?>/news.php" class="btn btn-primary">Ver todas las noticias</a>
        </div>
    </div>
</section>
