...
<?php
// Siempre incluir config.php primero para definir las constantes
...
// Proteger contra errores si las funciones no existen (por si config/functions no cargan bien)
$current_lang = function_exists('get_current_language') ? get_current_language() : (defined('DEFAULT_LANG') ? DEFAULT_LANG : 'es');
$current_page = function_exists('get_current_page') ? get_current_page() : '';
$header_texts = function_exists('load_language_file') ? load_language_file('header') : [];
function lang_url_safe($url, $lang) {
    return function_exists('lang_url') ? lang_url($url, $lang) : $url;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' - ' . SITE_NAME : SITE_NAME; ?></title>    <meta name="description" content="<?php echo isset($page_description) ? $page_description : 'Sepstar México S DE RL DE CV - Líder en fabricación de alta calidad de componentes para electrodomésticos y automotriz. Innovación y excelencia en manufactura mexicana.'; ?>">
      <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo BASE_URL; ?>img/logo%20y%20favicon/favicon_sepstar.ico" type="image/x-icon">
    ...
    <script type="application/ld+json">
    {
      ...
      "logo": "<?php echo SITE_URL; ?>img/logo/logo%20sepstar.png",
      "contactPoint": {
        "@type": "ContactPoint",
    ...
    <meta property="og:image" content="<?php echo isset($page_image) ? $page_image : SITE_URL . 'img/fotos%20de%20fabrica%20y%20opengraph/opengraph.jpg'; ?>">
    ...
    <meta property="twitter:image" content="<?php echo isset($page_image) ? $page_image : SITE_URL . 'img/fotos%20de%20fabrica%20y%20opengraph/opengraph.jpg'; ?>">
...
<body class="page-<?php echo $current_page; ?>">
    ...
    <header class="header">
        ...
        <div class="main-header py-3">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4">                        <div class="logo">                            <a href="<?php echo BASE_URL; ?>">
                            ...
                            <div class="collapse navbar-collapse" id="navbarMain">
                                <ul class="navbar-nav ms-auto">
                                    <li class="nav-item <?php echo ($current_page == 'index') ? 'active' : ''; ?>">
                                        <a class="nav-link" href="<?php echo BASE_URL; ?>"><?php echo $header_texts['home']; ?></a>
                                    </li>
                                    <li class="nav-item <?php echo ($current_page == 'about') ? 'active' : ''; ?>">
                                        <a class="nav-link" href="<?php echo BASE_URL; ?>about.php"><?php echo $header_texts['about']; ?></a>
                                    </li>
                                    <li class="nav-item <?php echo ($current_page == 'manufacturing') ? 'active' : ''; ?>">
                                        <a class="nav-link" href="<?php echo BASE_URL; ?>manufacturing.php"><?php echo $header_texts['manufacturing']; ?></a>
                                    </li>
                                    <li class="nav-item <?php echo ($current_page == 'products') ? 'active' : ''; ?>">
                                        <a class="nav-link" href="<?php echo BASE_URL; ?>products.php"><?php echo $header_texts['products']; ?></a>
                                    </li>
                                    <li class="nav-item <?php echo ($current_page == 'news') ? 'active' : ''; ?>">
                                        <a class="nav-link" href="<?php echo BASE_URL; ?>news.php"><?php echo $header_texts['news']; ?></a>
                                    </li>
                                    <li class="nav-item <?php echo ($current_page == 'contact') ? 'active' : ''; ?>">
                                        <a class="nav-link" href="<?php echo BASE_URL; ?>contact.php"><?php echo $header_texts['contact']; ?></a>
                                    </li>
                                </ul>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="<?php echo BASE_URL; ?>"><?php echo $header_texts['home']; ?></a></li>
    ...
    <div id="loading-icon" style="display:none; position:fixed; top:50%; left:50%; transform:translate(-50%, -50%);">
        <img src="<?php echo BASE_URL; ?>img/loading-star-orange.gif" alt="Cargando...">
    </div>
